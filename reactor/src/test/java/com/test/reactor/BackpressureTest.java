...
public class BackpressureTest {
    private static final int EVENT_DURATION = 10;    // 生成的事件间隔时间，单位毫秒
    private static final int EVENT_COUNT = 20;    // 生成的事件个数
    private static final int PROCESS_DURATION = 100;    // 订阅者处理每个元素的时间，单位毫秒
...
//                .onBackpressureError()
                .publishOn(Schedulers.newSingle("newSingle"), prefetch)
                .doOnRequest(n -> System.out.println(" ===  request: " + n + " ===")); // n == prefetch
    }
    ...
    public void testCreateBackPressureStrategy() {
        // BUFFER/DROP/LATEST/ERROR/IGNORE
